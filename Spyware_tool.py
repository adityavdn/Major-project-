...
conn = sqlite3.connect("C:\Users\Public\Desktop\Google Chrome.lnk") #connect to the google chrome history database "add your path, I have used mine , you can use yours"
cursor = conn.cursor()
